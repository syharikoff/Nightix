...
void main() {
    ...
    vec2 flow = (texCoord0 + vec2(time * 0.035, -time * 0.025)) * shaderScale;
    ...
    vec3 rgb = vertexColor.rgb * (0.24 + mist * 0.20 + core * 0.88 + glow * 0.52);
    float alpha = vertexColor.a * clamp(0.24 + core * 0.74 + glow * 0.20, 0.0, 1.0);
