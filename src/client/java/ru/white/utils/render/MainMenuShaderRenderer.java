...
public class MainMenuShaderRenderer {
    ...
    private static final RenderPipeline PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.TRANSFORMS_AND_PROJECTION_SNIPPET)
                    ...
                    .withUniform("MainMenuGridData", UniformType.UNIFORM_BUFFER)
    ...
    private void ensureInitialized() {
        ...
        dummyVertexBuffer = RenderSystem.getDevice().createBuffer(
                () -> "client:main_menu_grid_dummy_vertex",
    ...
    private void uploadAndDraw(MinecraftClient client) {
        ...
        try (RenderPass renderPass = encoder.createRenderPass(
            ...
            renderPass.setUniform("MainMenuGridData", uniformBuffer);
