...
public enum Keyboard {
    ...
    MOUSE_1("MS1", GLFW.GLFW_MOUSE_BUTTON_1),
    MOUSE_2("MS2", GLFW.GLFW_MOUSE_BUTTON_2),
    MOUSE_3("MS3", GLFW.GLFW_MOUSE_BUTTON_3),
    MOUSE_4("MS4", GLFW.GLFW_MOUSE_BUTTON_4),
    MOUSE_5("MS5", GLFW.GLFW_MOUSE_BUTTON_5),
    MOUSE_6("MS6", GLFW.GLFW_MOUSE_BUTTON_6),
    MOUSE_7("MS7", GLFW.GLFW_MOUSE_BUTTON_7),
    MOUSE_8("MS8", GLFW.GLFW_MOUSE_BUTTON_8),
